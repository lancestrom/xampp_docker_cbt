...
<!-- Data Table -->
<script src="<?= base_url() ?>assets/vendor/sbadmin/vendor/datatables/jquery.dataTables.min.js"></script>
<script src="<?= base_url() ?>assets/vendor/sbadmin/vendor/datatables/dataTables.bootstrap4.min.js"></script>
